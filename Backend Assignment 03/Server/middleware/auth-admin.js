...
module.exports = (req, res, next) => {
  // Use cookie-parser's populated req.cookies instead of manual fragile parsing
  ...
  try {
    // Verify using the unified secret (env var or random), not hardcoded "ASSIGNMENT3$"
