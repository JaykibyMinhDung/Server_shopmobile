...
module.exports = (req, res, next) => {
  // Sentinel Fix: Use cookie-parser's req.cookies instead of fragile manual parsing
  ...
  try {
    // Sentinel Fix: Replaced hardcoded secret "ASSIGNMENT3$" with secure getJwtSecret()
    // This fixes CWE-798 (Use of Hard-coded Credentials)
